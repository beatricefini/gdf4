document.addEventListener("DOMContentLoaded", () => {
  ...
  function initModelsSequence() {
    ...
    function createFinalModel(){
      ...
      textRenovation.setAttribute('animation__fadein',{
        ...
        from:0,
        to:1,
        dur:800,document.addEventListener("DOMContentLoaded", () => {
  console.log("🚀 main.js avviato");
  ...
  // --- Mantieni sequenza se marker viene perso e ritrovato ---
  marker.addEventListener('targetFound', () => {
    if(!sequenceStarted){
      sequenceStarted = true;
    }
    // Non resettare nulla: i click continueranno la sequenza da dove era rimasta
  });
});
